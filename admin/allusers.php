...
if (isset($_POST['toggle_status'])) {
    // Get the user_id and current status from the POST request
    ...
    $sql = "UPDATE users SET status = '$new_status' WHERE u_id = $user_id";
    
    if (mysqli_query($db, $sql)) {
        // If the update is successful, redirect back to the previous page (or any other page)
        // header("Location: users_list.php?status_change=success");
    } else {
...
<body class="fix-header fix-sidebar">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <!-- Logo icon -->
                        <b><img src="images/logo.png" alt="homepage" class="dark-logo ml-4" /></b>
                    </a>
                </div>
                <!-- End Logo -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"><a href="dashboard.php">Dashboard ></a> users</h3> </div>
    ...
    if (!mysqli_num_rows($query) > 0) {
        ...
        while ($rows = mysqli_fetch_array($query)) {
            ...
            $status = strtolower($rows['status']); // Convert to lowercase

            // Set the button text and class based on the current status
