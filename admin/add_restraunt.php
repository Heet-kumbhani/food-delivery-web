                   ...
                   <ul id="sidebarnav">
                       ...
                       <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i aria-hidden="true">₹</i><span class="hide-menu">Income</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_orders.php">Income</a></li>
                            </ul>
                        </li>
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="res_name" class="form-control" placeholder="Restaurant name" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Bussiness E-mail *</label>
                                                <input type="text" name="email" class="form-control form-control-danger" placeholder="example@gmail.com" require>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control" placeholder="5555 555 555" require>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_hr" class="form-control custom-select" data-placeholder="Choose a Category" require>
                                        ...
                                        <!--/span-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="c_hr" class="form-control custom-select" data-placeholder="Choose a Category" require>
                                                    <option>--Select your Hours--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" require>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input type="file" name="file"  id="lastName" class="form-control form-control-danger" placeholder="12n"require>
                                            </div>
                                        </div>
										<!-- <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control" require></textarea>
                                                </div>
                                            </div>
                                        </div>
