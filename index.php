    ...
    <div class="container">
        ...
        <div class="collapse navbar-toggleable-md float-lg-right" id="mainNavbarCollapse">
            <ul class="nav navbar-nav">
                ...
                if (empty($_SESSION["user_id"])) { // If user is not logged in
                    ...
                    // echo '<li class="nav-item"><a href="user-info.php" class="nav-link active">Your profile</a></li>';
                }
                ?>
            </ul>
        </div>
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
                <?php
    // Query to get the dishes along with the review count for each dish
                ...
                <div class="food-item-wrap">
                    <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
                        ...
                        <div class="review pull-right">
                            <a href="#">' . $r['review_count'] . ' reviews</a>
                        </div>
                    </div>
                    <div class="content">
                        <h5><a href="dishes.php?res_id='.$r['rs_id'].'">'.$r['d_name'].'</a></h5>
                        <div class="product-name">'.$r['d_discription'].'</div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						$ress= mysqli_query($db,"select * from restaurant WHERE status = 'active'");
														...
														<div class="restaurant-wrap">
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="dishes.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['res_name'].'<br>'.$rows['address'].'</span>
