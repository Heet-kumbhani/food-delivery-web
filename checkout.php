...
{	
    ...
    if ($_POST['submit']) {
        ...
        $sqlTitle = "SELECT d_name FROM dishes WHERE d_id = ?";
        $stmt = $db->prepare($sqlTitle);
        ...
        $SQL = "INSERT INTO users_orders (u_id, title, quantity, price, d_id) 
                VALUES (?, ?, ?, ?, ?)";
        $stmtInsert = $db->prepare($SQL);
        $stmtInsert->bind_param('isdis', $_SESSION["user_id"], $dishTitle, $item["quantity"], $item["price"], $item["d_id"]);
        $stmtInsert->execute();
                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Paypal <img src="images/paypal.jpg" alt="" width="90"> can't be use this service</span> </label>
                                            </li>
                                        </ul>
                    ...
                    <div class="row top-footer">
                        ...
                        <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Wait for delivery</a> </li>f
                            </ul>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: <a href="tel:+919978059125">+91 992 491 2371</a></h5> </div>
